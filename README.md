...
## Key Features 💡:
• Secure Password Hashing: Used Argon2id with an extra layer of salt, making it computationally infeasible to reverse the hash due to its memory-intensive design. <br> 
